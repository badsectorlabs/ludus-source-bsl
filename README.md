...
Ludus blueprints, Packer templates, and Ansible roles & collections for offensive security labs. Add the source once, build the templates a blueprint needs, then apply it to spin up a fully configured range.
